...
public class WorkDay {
     ...
     * @throws Exceptions.FutureWorkException 
     */
     ...
     * @param month : {@link Integer Integer} has to be between 1 and 12
     * @param day : {@link Integer Integer} has to be between 1 and 31, be mindful about the length of the month 
     * @throws Exceptions.NegativeMinutesOfWorkException 
     * @throws Exceptions.FutureWorkException 
     */
     ...
     * @throws Exceptions.NotSeparatedTimesException 
     * @throws Exceptions.EmptyTimeFieldException 
     */
